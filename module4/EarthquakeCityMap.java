...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		fill(150,40,0);
		triangle(50,107,60, 87, 70, 107);
		fill(0);
		text("City Marker", 75, 100);
		fill(255);
		ellipse(60,125,20,20);
		rect(50,140,20,20);
		fill(0);
		text("Land Quake", 75, 123);
		text("Ocean Quake", 75, 147);
		text("Size ~ Magnitude", 50, 172);
	}
	...
	private boolean isLand(PointFeature earthquake) {
		...
		for (Marker m : countryMarkers) {
			...
			if(isInCountry(earthquake, m)==true) return true;
		}
	...
	private void printQuakes() 
	{
        ...
        System.out.println("Ocean: " + totalQuakes);
